...
pub fn run(engine: &mut Engine, depth: usize) {
    let mut commands = String::new();
    commands.push_str("uci\n");
    commands.push_str("setoption name Hash value 128\n");
    commands.push_str("setoption name SyzygyPath value /home/bendik/goldfish/syzygy\n");
    commands.push_str("isready\n");
...
pub const BENCH_CASES: [&str; 39] = [
    ...
    "r2r1n2/pp2bk2/2p1p2p/3q4/3PN1QP/2P3R1/P4PP1/5RK1 w - - 0 1",   // mate in 4
];
