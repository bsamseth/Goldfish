...
// Move white pawn
int move = Move::value_of(MoveType::NORMAL, Square::A2, Square::A3, Piece::WHITE_PAWN, Piece::NO_PIECE,
...
// Move black pawn
move = Move::value_of(MoveType::NORMAL, Square::B7, Square::B6, Piece::BLACK_PAWN, Piece::NO_PIECE,
                      PieceType::NO_PIECE_TYPE);
position.
make_move(move);
...
// Move white knight
move = Move::value_of(MoveType::NORMAL, Square::B1, Square::C3, Piece::WHITE_KNIGHT, Piece::NO_PIECE,
                      PieceType::NO_PIECE_TYPE);
position.
make_move(move);
...
// Move white knight
int move = Move::value_of(MoveType::NORMAL, Square::B1, Square::C3, Piece::WHITE_KNIGHT, Piece::NO_PIECE,
                          PieceType::NO_PIECE_TYPE);
position.
make_move(move);

// Move black knight
move = Move::value_of(MoveType::NORMAL, Square::B8, Square::C6, Piece::BLACK_KNIGHT, Piece::NO_PIECE,
                      PieceType::NO_PIECE_TYPE);
position.
make_move(move);

// Move white knight
move = Move::value_of(MoveType::NORMAL, Square::G1, Square::F3, Piece::WHITE_KNIGHT, Piece::NO_PIECE,
                      PieceType::NO_PIECE_TYPE);
position.
make_move(move);

// Move black knight
move = Move::value_of(MoveType::NORMAL, Square::C6, Square::B8, Piece::BLACK_KNIGHT, Piece::NO_PIECE,
                      PieceType::NO_PIECE_TYPE);
position.
make_move(move);

// Move white knight
move = Move::value_of(MoveType::NORMAL, Square::F3, Square::G1, Piece::WHITE_KNIGHT, Piece::NO_PIECE,
                      PieceType::NO_PIECE_TYPE);
position.
make_move(move);
...
int move = Move::value_of(MoveType::PAWN_DOUBLE, Square::A2, Square::A4, Piece::WHITE_PAWN, Piece::NO_PIECE,
                          PieceType::NO_PIECE_TYPE);
position.
make_move(move);
...
int move = Move::value_of(MoveType::PAWN_PROMOTION, Square::A7, Square::A8, Piece::WHITE_PAWN, Piece::NO_PIECE,
                          PieceType::QUEEN);
position.
make_move(move);
...
EXPECT_EQ("8/P5k1/8/8/2K5/8/8/8 w - - 0 1",
...
int move = Move::value_of(MoveType::EN_PASSANT, Square::E4, Square::D3, Piece::BLACK_PAWN, Piece::WHITE_PAWN,
                          PieceType::NO_PIECE_TYPE);
position.
make_move(move);
...
EXPECT_EQ("5k2/8/8/8/3Pp3/8/8/3K4 b - d3 0 1",
Notation::from_position(position)
);
EXPECT_EQ(zobrist_key, position
.zobrist_key);
...
int move = Move::value_of(MoveType::CASTLING, Square::E1, Square::C1, Piece::WHITE_KING, Piece::NO_PIECE,
                          PieceType::NO_PIECE_TYPE);
position.
make_move(move);

EXPECT_EQ(+Castling::NO_CASTLING, position.
...
move = Move::value_of(MoveType::CASTLING, Square::E1, Square::G1, Piece::WHITE_KING, Piece::NO_PIECE,
                      PieceType::NO_PIECE_TYPE);
position.
make_move(move);
