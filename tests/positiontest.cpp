...
TEST(positiontest, test_active_color) {
    ...
    // Move white pawn
    Move move = Moves::value_of(MoveType::NORMAL, Square::A2, Square::A3,
            Piece::WHITE_PAWN, Piece::NO_PIECE, PieceType::NO_PIECE_TYPE);
    position.make_move(move);
    EXPECT_EQ(Color::BLACK, position.active_color);

    // Move black pawn
    move = Moves::value_of(MoveType::NORMAL, Square::B7, Square::B6,
            Piece::BLACK_PAWN, Piece::NO_PIECE, PieceType::NO_PIECE_TYPE);
    position.make_move(move);
...
TEST(positiontest, test_half_moveClock) {
    ...
    // Move white knight
    move = Moves::value_of(MoveType::NORMAL, Square::B1, Square::C3,
            Piece::WHITE_KNIGHT, Piece::NO_PIECE, PieceType::NO_PIECE_TYPE);
    position.make_move(move);
...
TEST(positiontest, test_is_repetition) {
    ...
    // Move white knight
    Move move = Moves::value_of(MoveType::NORMAL, Square::B1, Square::C3,
            Piece::WHITE_KNIGHT, Piece::NO_PIECE, PieceType::NO_PIECE_TYPE);
    position.make_move(move);

    // Move black knight
    move = Moves::value_of(MoveType::NORMAL, Square::B8, Square::C6,
            Piece::BLACK_KNIGHT, Piece::NO_PIECE, PieceType::NO_PIECE_TYPE);
    position.make_move(move);
...
TEST(positiontest, test_normal_move) {
    ...
    Move move = Moves::value_of(MoveType::NORMAL, Square::A2, Square::A3, Piece::WHITE_PAWN, Piece::NO_PIECE,
            PieceType::NO_PIECE_TYPE);
    position.make_move(move);
...
TEST(positiontest, test_pawn_doubleMove) {
    ...
    Move move = Moves::value_of(MoveType::PAWN_DOUBLE, Square::A2, Square::A4, Piece::WHITE_PAWN, Piece::NO_PIECE,
            PieceType::NO_PIECE_TYPE);
    position.make_move(move);
...
TEST(positiontest, test_pawn_promotionMove) {
    ...
    Move move = Moves::value_of(MoveType::PAWN_PROMOTION, Square::A7, Square::A8, Piece::WHITE_PAWN, Piece::NO_PIECE,
            PieceType::QUEEN);
    position.make_move(move);
...
TEST(positiontest, test_enpassantMove
    ...
    Move move = Moves::value_of(MoveType::EN_PASSANT, Square::E4, Square::D3, Piece::BLACK_PAWN, Piece::WHITE_PAWN,
            PieceType::NO_PIECE_TYPE);
    position.make_move(move);
...
TEST(positiontest, test_castling_move) {
    ...
    Move move = Moves::value_of(MoveType::CASTLING, Square::E1, Square::C1, Piece::WHITE_KING, Piece::NO_PIECE,
            PieceType::NO_PIECE_TYPE);
    position.make_move(move);
